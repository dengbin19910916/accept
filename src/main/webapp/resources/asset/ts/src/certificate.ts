...
namespace preaccept {
    export namespace model {
        namespace GenderException {
            export class GenderParseError extends Error {
        ...
        interface Validatable {
            /**
             * 验证数据是否正确。
             * @returns {Boolean} 验证结果，true - 正确，false - 不正确。
             */
            isValid(): boolean;
        }
         ...
         * 证件对象的抽象父类型。
         */
        export abstract class Card implements Validatable{
